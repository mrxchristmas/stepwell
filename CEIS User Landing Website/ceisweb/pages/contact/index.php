...
<head>
    ...
    <title>Prodocuflow - Contact</title>
...
<body>
    ...
    ?>
    <script src="./controller/js/api_confirm.js" type="text/javascript"></script>
    <script src="./controller/js/api_register.js" type="text/javascript"></script>
